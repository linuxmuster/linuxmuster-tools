...
\lhead{\bf Liste des identifiants}
...
\begin{center}
\large \texttt{ {{ student['lastname'] }}, {{ student['firstname'] }} } \par Classe: \texttt{ {{ student['schoolclass'] }} } \par Mot de passe: \texttt{ {{ student['password'] }} } \par Login: \texttt{ {{ student['login'] }} }
\end{center}
\end{minipage}%
}
